...
Empleado.saludo();
Empleado.saludo2(empleado);

console.log(persona.ContadorObjetosPersona); //variable nueva creada
console.log(Persona.ContadorObjetosPersona); //variable estatica de clase padre
console.log(Empleado.ContadorObjetosPersona); //variable estatica de clase hija
